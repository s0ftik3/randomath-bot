...
function defineLevel(trueAnswers, falseAnswers, addition, subtraction, multiplication, division, comparison, lang = 'EN') {
    ...
    if (lang === 'EN') {
        ...
        if (correct <= 0) {    
            ...
            nextLevel = `👍 You have reached the the maximum level and now you are available to see the full statistics.`
        }
        ...
        if (correct <= 0) {    
            ...
            nextLevel = `👍 Вы достигли максимального уровня и теперь Вам доступна полная статистика о Ваших ответах.`
        }
